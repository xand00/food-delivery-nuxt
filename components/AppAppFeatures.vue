<template>
    <div>
        <app-feature-card
            v-for="(appFeature, index) in this.appFeatures"
            v-bind="appFeature"
        ...
        data() {
            return {
                appFeatures: [
                    ...
                    imageSrc: "/index-feature-cards-1.png",
                    },
                    {
                    id: 2,
                    name: "Explore while shopping",
                    ...
                    imageSrc: "/index-feature-cards-2.png",
                    },
                    {
                    id: 3,
                    name: "Checkout",
                    ...
                    imageSrc: "/index-feature-cards-3.png",
                    },
                ]
            }
        }
